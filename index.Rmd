...
<!-- [[embed src="https://youtu.be/e0mEAo3anwI"]] -->


<embed align="center" src="https://www.youtube.com/embed/e0mEAo3anwI" width="400">
...
Д а й   м н е   Б о г   п о н я т ь ,
К а к   м и г   п р о з р е н ь я  
Л ю д я м   п е р е д а т ь !
...
Г д е   б ы   н е   б ы л   я – 
В с е г д а   с о   м н о ю  р а д о с т ь    б ы т и я.
...
##  Медитация \#16 (В мечтаньях)

TBD

##  Медитация \#22 (Выше небес)
...
Легка и прелестна, почти бестелесна, 
...
(Проигрыш - вместо первых 6 строк куплета)  
...
Одну лишь самбу, и только самбу
Танцую я 
одну лишь Samba
танцую Samba я.
...
это все из-за тебя родная
Мне интересны больше не фокстрот не ча-ча-ча
...
On piano, играет Люда Городничая (из музея-архива семьи Городничих в Киеве) : https://youtu.be/phoncqrWLv4
...
<cite>
Музыка: А. Жобим. 
Слова: Иващенко (Адаптация Городничий)
</cite> <pre>
...
<blockquote>
<cite>
(Музыка: А. Жобим, Слова: Д. Городничий, не окончена )
</cite> 
<pre> 
Хотела я  узнать,  откуда
...
что есть источник знаний и добра 
чистый как вода 
вечный как сама наша Земля 
nazyvaetsq
Aqua de beber камарад. 

И Я пошла бродить по свету 
Я поднялась выше небес. 
Услышала много песен я неспетых,
но не найдя ничего вернулась к себе.
...
Мой друг, и мой учитель есть сама вода. 

Я понял всё в человеке должно быть красивым 
слова и мысли и дела 
И это есть условием необходимым 
Чтобы достигнуть тут цель, для которой Мама нас родила. 


Я так хотел узнать зачем 
пришли в этот мир и как нам жить. 
И вот ответ Чтобы быть любимым
и жить надо так чтобы другим любовь дарить.


Aqua de beber 
agua de beber commarade
...
Я так рад. 
Чтоб не делал я 
жизнь С тобою полноценный во сто крат
agua de beber comorade
