...
github-repo: "gorodnichy/jobim"
site: bookdown::bookdown_site
url: 'http\://bookdown.org/gorodnichy/jobim/'
...
#      in_header: html_header.html  # uncomment for javascript-pulldowns
    config:
      toc:
          collapse: section
      before: |
        <li><a href="https://bookdown.org/gorodnichy/jobim">bookdown.org/gorodnichy/jobim</a></li>
      after: |
        <li> <a href="http://gorodnichy.ca">Gorodnichy, IVIM Inc. &copy; 2016-2021 </a> </li>
    download: [epub,pdf]
...
Appendix provides the statistical  analysis of lyrics using data science tools. The source of this book is available in [github](https://github.com/gorodnichy/Shri-Jobim). Contributions are welcome.
