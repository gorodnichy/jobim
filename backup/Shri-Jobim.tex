...
%D7 \PassOptionsToPackage{latin9}{inputenc} % latin9 (ISO-8859-9) = latin1+"Euro sign"
...
\begingroup
\color{Maroon}\spacedallcaps{Shri Jobim} \\Interpretation of Jobim in Ukrainian and Russian\\ \bigskip % Thesis title
\endgroup

\spacedlowsmallcaps{Dmitry Gorodnichy} % Your name

\vfill

%D7 \includegraphics[width=6cm]{images/bookdownplus-logo.pdf} \\ \medskip % Picture
...
\chapter{\texorpdfstring{``Shri Jobim''}{Shri Jobim}}\label{jobim}
...
UNDER DEVELOPMENT: Version: Last compiled: 2017-12-30

\begin{longtable}[]{@{}lccccc@{}}
\toprule
Title & Original & Back track & Instrumental & Audio &
Video\tabularnewline
\midrule
\endhead
